...
//
// Framework-template copy — origin: VioletApp M5.9 (.claude/hooks/package-guard.js).
// ONLY allowed divergence from the origin: BLOCK_RUNTIME_DEPS = false here (spec §6).
...
// SR-06 is project-specific: generic projects have runtime dependencies, so the
// template ships this rule OFF. Projects with a frozen dependencies:{} (e.g. the
// VioletApp origin of this hook) set it to true.
const BLOCK_RUNTIME_DEPS = false;
