...
hier aus nicht feststellen), welche Recommender-Empfehlungen umgesetzt bzw. zurückgestellt
wurden, und das Ergebnis der Workflow-Retrospektive (welche wiederkehrenden Probleme in welche
Ebene codifiziert wurden, oder „keine neue Reibung").
